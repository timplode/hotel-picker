...
export interface ApiConferenceGroupConferenceGroup
  extends Struct.CollectionTypeSchema {
  collectionName: 'conference_groups';
  info: {
    displayName: 'ConferenceGroup';
    pluralName: 'conference-groups';
    singularName: 'conference-group';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    allowLoginsAfterDateTime: Schema.Attribute.DateTime &
      Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailVisibility: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    lastResetSentAt: Schema.Attribute.DateTime;
    lastVerificationSentAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHotelConferenceHotelConference
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateToSendCSVFile: Schema.Attribute.Date;
    hasBusParking: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    hasTransitToVenue: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    taxRatePercentage: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    taxRatePercentageNonProfit: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHotelHotel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<
      ...
      true
    >;
    longName: Schema.Attribute.Text;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    old_id: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billingAddressee: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    requiresBusParking: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
...
export interface ApiUserSegmentUserSegment extends Struct.CollectionTypeSchema {
  collectionName: 'user_segments';
  info: {
    displayName: 'UserSegment';
    pluralName: 'user-segments';
    singularName: 'user-segment';
  };
  options: {
    draftAndPublish: false;
  };
